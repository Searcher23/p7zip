...
public class ExtractFile {
	...
	public ExtractFile(File file, File outputDirOrCompressionLevel) throws IOException, RarException, Exception {
		this(file.getAbsolutePath(), outputDirOrCompressionLevel.getAbsolutePath());
	}
	
	public ExtractFile(String f, String outputDirOrCompressionLevel) throws IOException, RarException {
	...
	private void init() throws IOException, RarException {
		if (arch != null) {
			arch.close();
			arch = new Archive(file);
			curFileHeader = null;
			Log.d("reinited rar", filePath);
		} else if (andro7z != null) {
	...
	public void copyTo(ExtractFile ef) throws RarException, IOException {
	...
	public String extractFile(String entryName) throws IOException, RarException, Exception {
...
//					Log.d("fh.isDirectory()", fh.isDirectory() + "");
	...
	public void extractEntries(Collection<String> entryNames, boolean overwrite) throws Exception {
		...
		if (arch != null) {
			...
			List<String> l = new ArrayList<>(entryNames.size());
...
//			}
	...
	public String rar2UrlStr(String folderName, boolean number, String sep) throws IOException, RarException {
	...
	public String compressedFile2UrlStr(String folderName, boolean number, String sep) throws IOException, RarException, Exception {
	...
	public static void main(String[] args) throws IOException, RarException, Exception {
